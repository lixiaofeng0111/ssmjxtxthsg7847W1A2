...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateXueshengguanxishenqing.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">修改学生关系申请<input type="hidden" name="id" value="${xueshengguanxishenqing.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.yonghuming.value='${xueshengguanxishenqing.yonghuming}';</script>	<script language="javascript">document.form1.xingming.value='${xueshengguanxishenqing.xingming}';</script>	<script language="javascript">document.form1.xingbie.value='${xueshengguanxishenqing.xingbie}';</script>	<script language="javascript">document.form1.dianhua.value='${xueshengguanxishenqing.dianhua}';</script>	<script language="javascript">document.form1.shenfenzheng.value='${xueshengguanxishenqing.shenfenzheng}';</script>	<script language="javascript">document.form1.xuehao.value='${xueshengguanxishenqing.xuehao}';</script>	<script language="javascript">document.form1.xueshengxingming.value='${xueshengguanxishenqing.xueshengxingming}';</script>	<script language="javascript">document.form1.xueshengguanxi.value='${xueshengguanxishenqing.xueshengguanxi}';</script>	
					 </table>
			</form>
   </body>
</html>
