...
<td width='11%' height=100  >备注：</td><td width='39%' colspan=2 height=100 >${yonghuzhuce.beizhu}</td></tr><tr><td height="45" colspan=3 align=center><input type=button name=Submit5 value=返回 onClick="javascript:history.back()"  class="btn btn-info btn-small" />&nbsp;</td></tr>
