...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td colspan="17" background="images/table_header.gif">考试安排列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="kaoshianpaiList2.do" name="myform" method="post">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.changci}</td>    <td>${u.kechengmingcheng}</td>    <td>${u.jiaoshihao}</td>    <td>${u.kaoshishijian}</td>    <td>${u.kaoshishiduan}</td>    <td>${u.shuoming}</td>    <td>${u.faburen}</td>    
                              ...
                              <td height="45" align="center"><a class="btn btn-info btn-small" href="doUpdateKaoshianpai.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteKaoshianpai.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="ksapDetail.do?id=${u.id }" target="_blank">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="kaoshianpaiList2.do?page=1" >首页</a>
             <a href="kaoshianpaiList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="kaoshianpaiList2.do?page=${page.page+1 }">下一页</a>
			<a href="kaoshianpaiList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
