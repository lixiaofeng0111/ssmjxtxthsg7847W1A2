...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="xueshengguanxishenqingList2.do" name="myform" method="post">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.yonghuming}</td>    <td>${u.xingming}</td>    <td align='center' bgcolor='#ebf0f7'>${u.xingbie}</td>    <td>${u.dianhua}</td>    <td>${u.shenfenzheng}</td>    <td>${u.xuehao}</td>    <td>${u.xueshengxingming}</td>    <td>${u.xueshengguanxi}</td>    <td align='center'>${u.issh} </td>
                              ...
                              <td height="45" align="center"><a class="btn btn-info btn-small" href="doUpdateXueshengguanxishenqing.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteXueshengguanxishenqing.do?id=${u.id }"
		 ...
		 <c:if test="${page.page>1}">
              <a href="xueshengguanxishenqingList2.do?page=1" >首页</a>
             <a href="xueshengguanxishenqingList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="xueshengguanxishenqingList2.do?page=${page.page+1 }">下一页</a>
			<a href="xueshengguanxishenqingList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
