...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateKaoshianpai.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">修改考试安排<input type="hidden" name="id" value="${kaoshianpai.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.changci.value='${kaoshianpai.changci}';</script>	<script language="javascript">document.form1.kechengmingcheng.value='${kaoshianpai.kechengmingcheng}';</script>	<script language="javascript">document.form1.jiaoshihao.value='${kaoshianpai.jiaoshihao}';</script>	<script language="javascript">document.form1.kaoshishijian.value='${kaoshianpai.kaoshishijian}';</script>	<script language="javascript">document.form1.kaoshishiduan.value='${kaoshianpai.kaoshishiduan}';</script>	<script language="javascript">document.form1.shuoming.value='${kaoshianpai.shuoming}';</script>	<script language="javascript">document.form1.faburen.value='${kaoshianpai.faburen}';</script>	
					 </table>
			</form>
   </body>
</html>
