...
<form action="wjdcList.do" name="myform" method="post" style="width:100%">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.bianhao}</td>    <td>${u.wenti1}</td>    <td>${u.wenti2}</td>    <td>${u.wenti3}</td>    <td>${u.wenti4}</td>    <td>${u.faburen}</td>    
                              ...
                              <td align="center"><a href="wjdcDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table>
<br>
...
<p align="center"> <c:if test="${sessionScope.p==1 }">
		 <c:if test="${page.page>1}">
              <a href="wjdcList.do?page=1" >首页</a>
             <a href="wjdcList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="wjdcList.do?page=${page.page+1 }">下一页</a>
			<a href="wjdcList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
