...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateXuejixinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">修改学籍信息<input type="hidden" name="id" value="${xuejixinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.xuehao.value='${xuejixinxi.xuehao}';</script>	<script language="javascript">document.form1.xingming.value='${xuejixinxi.xingming}';</script>	<script language="javascript">document.form1.xingbie.value='${xuejixinxi.xingbie}';</script>	<script language="javascript">document.form1.zhaopian.value='${xuejixinxi.zhaopian}';</script>	<script language="javascript">document.form1.minzu.value='${xuejixinxi.minzu}';</script>	<script language="javascript">document.form1.jiguan.value='${xuejixinxi.jiguan}';</script>	<script language="javascript">document.form1.shenfenzheng.value='${xuejixinxi.shenfenzheng}';</script>	<script language="javascript">document.form1.ruxueshijian.value='${xuejixinxi.ruxueshijian}';</script>	<script language="javascript">document.form1.zhuanye.value='${xuejixinxi.zhuanye}';</script>	<script language="javascript">document.form1.yuanxiao.value='${xuejixinxi.yuanxiao}';</script>	<script language="javascript">document.form1.cengci.value='${xuejixinxi.cengci}';</script>	<script language="javascript">document.form1.xuejizhuangtai.value='${xuejixinxi.xuejizhuangtai}';</script>	<script language="javascript">document.form1.beizhu.value='${xuejixinxi.beizhu}';</script>	<script language="javascript">document.form1.gonghao.value='${xuejixinxi.gonghao}';</script>	
					 </table>
			</form>
   </body>
</html>
