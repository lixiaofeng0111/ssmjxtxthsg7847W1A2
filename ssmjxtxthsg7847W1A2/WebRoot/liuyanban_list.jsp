				...
				<table width="100%" border="1" align="center" cellpadding="4"
								...
								<tr align="left">
									<td height="30" colspan="17">
										<form action="liuyanbanList.do" name="myform" method="post">
											查询 昵称：<input name="cheng" type="text" id="cheng"
												class="form-control2" /> 性别：<input name="xingbie"
												type="text" id="xingbie" class="form-control2" /> <input
					...
					<tr align="center">
						<td style="padding-left: 0px; padding-right: 0px;"><table
								width="100%" border="0" align="center" cellpadding="4"
								...
								<tr>
									...
									<td width="150px" height="30" align="center" bgcolor="#ebf0f7">
										添加时间</td>
									<td width="150px" height="30" align="center" bgcolor="#ebf0f7">
										操作</td>
								</tr>
								...
								<c:forEach items="${list }" var="u">
									...
									<tr align="center" bgcolor="#FFFFFF">
										...
										<td>${u.cheng}</td>
										<td align='center'><img width='70' height='70'
											src=img/${u.xingbie}.gif border=0></td>
										<td>${u.QQ}</td>
										<td>${u.youxiang}</td>
										<td>${u.shouji}</td>
										<td>${u.neirong}</td>
										...
										<td align="center"><a class="btn btn-info btn-small"
											href="doUpdateLiuyanbanlb.do?id=${u.id}">回复</a></td>
									</tr>
								</c:forEach>
							</table></td>
					</tr>
	...
	<p align="center" class="fy">
		<c:if test="${sessionScope.p==1 }">
			<c:if test="${page.page>1}">
				...
				<a href="liuyanbanList.do?page=${page.page-1 }"> 上一页</a>
			</c:if>
			<c:if test="${page.page<page.totalPage}">
				<a href="liuyanbanList.do?page=${page.page+1 }">下一页</a>
				<a href="liuyanbanList.do?page=${page.totalPage }">末页</a>
			</c:if>
		</c:if>
	</p>
